...
export const SUGGESTIONS: Suggestion[] = [
  {
    ...
    lang: "de",
    cefr: "B1",
    why: "Natural conversations and street topics with Cari, Manuel, and Janusz for learners.",
  ...
  },
  {
    ...
    lang: "de",
    cefr: "A2",
    why: "Calm, clearly articulated episodes on German life, history, and everyday idioms.",
  ...
  },
  {
    ...
    lang: "de",
    cefr: "A1",
    why: "Step-by-step dialogues and practical explanations from A1 to B2.",
  ...
  },
  {
    ...
    lang: "de",
    cefr: "B1",
    why: "Current stories told in clear B1 German with key vocabulary explained.",
  ...
  },
  {
    ...
    lang: "de",
    cefr: "A1",
    why: "Follow Nico's story in Germany from scratch with short everyday scenes and clear A1 dialogues.",
    topics: ["Easy German", "German Learning", "Video"],
    video: true,
  },
  {
    ...
    lang: "de",
    cefr: "A2",
    why: "Season 2 of Nico's journey in Germany: everyday life, work, and society at A2 pace.",
    topics: ["Easy German", "German Learning", "Video"],
    video: true,
  },
  {
    ...
    lang: "de",
    cefr: "B1",
    why: "Season 3 of Nico's Weg: deeper conversations and real-life situations at B1 level.",
    topics: ["Easy German", "German Learning", "Video"],
    video: true,
  },
  {
    ...
    lang: "de",
    cefr: "A1",
    why: "Structured bite-sized lessons building conversational German from scratch.",
    topics: ["Easy German", "German Learning"],
  },
  {
...
export const ENGLISH_SOURCES: Suggestion[] = [
  ...
  {
    query: "With Interest CPA Australia",
    feedUrl: "https://rss.libsyn.com/shows/77644/destinations/350259.xml",
    label: "With Interest (CPA Australia)",
    publisher: "CPA Australia",
    lang: "en",
    why: "CPA Australia's flagship podcast: economic analysis, tax, regulatory change, and business leadership.",
    topics: ["Accounting", "Finance", "Business", "Leadership"],
  },
  {
    query: "INTHEBLACK CPA Australia",
    feedUrl: "https://rss.libsyn.com/shows/452592/destinations/3803988.xml",
    label: "INTHEBLACK (CPA Australia)",
    publisher: "CPA Australia",
    lang: "en",
    why: "Strategic business insights, workplace transformation, and executive leadership from CPA Australia's magazine.",
    topics: ["Accounting", "Business", "Leadership"],
  },
  {
    query: "Journal of Accountancy Podcast AICPA",
    feedUrl: "https://rss.libsyn.com/shows/306059/destinations/2448536.xml",
    label: "Journal of Accountancy",
    publisher: "AICPA & CIMA",
    lang: "en",
    why: "Key developments in tax, auditing, regulatory compliance, and management accounting from AICPA & CIMA.",
    topics: ["Accounting", "Finance", "Tax"],
  },
  {
    query: "Accounting Best Practices Steve Bragg",
    feedUrl: "https://rss.libsyn.com/shows/19196/destinations/15459.xml",
    label: "Accounting Best Practices",
    publisher: "Steve Bragg",
    lang: "en",
    why: "Practical guidance on accounting standards, GAAP, internal controls, and finance team management.",
    topics: ["Accounting", "Finance"],
  },
  {
    query: "PwC Accounting Podcast",
    feedUrl: "https://rss.buzzsprout.com/276516.rss",
    label: "PwC's Accounting Podcast",
    publisher: "PwC",
    lang: "en",
    why: "Heather Horn and PwC experts discuss emerging accounting standards, SEC reporting, ESG, and finance trends.",
    topics: ["Accounting", "Finance"],
  },
  {
    query: "The Accounting Podcast Blake Oliver David Leary",
    feedUrl: "https://feeds.transistor.fm/cloud-accounting-podcast",
    label: "The Accounting Podcast",
    publisher: "Blake Oliver & David Leary",
    lang: "en",
    why: "The leading weekly news roundup on accounting technology, firm leadership, and industry trends.",
    topics: ["Accounting", "Tech", "Business"],
  },
  {
    query: "Accountancy Insights ICAEW",
    feedUrl: "https://rss.buzzsprout.com/1807351.rss",
    label: "ICAEW Accountancy Insights",
    publisher: "ICAEW",
    lang: "en",
    why: "Chartered accountants dissecting economic policy, corporate governance, auditing, and sustainability.",
    topics: ["Accounting", "Business", "Finance"],
  },
  {
    query: "Policy & Insights ACCA",
    feedUrl: "https://media.zencast.fm/insights/rss",
    label: "ACCA Policy & Insights",
    publisher: "ACCA",
    lang: "en",
    why: "Global accounting policy, economic research, and future of the profession from the ACCA.",
    topics: ["Accounting", "Finance", "Career"],
  },
  {
    query: "CFO Thought Leader Jack Sweeney",
    feedUrl: "https://feeds.captivate.fm/cfo-thought-leader/",
    label: "CFO Thought Leader",
    publisher: "Jack Sweeney",
    lang: "en",
    why: "Interviews with top Chief Financial Officers detailing financial strategy, capital allocation, and leadership.",
    topics: ["Finance", "Leadership", "Interviews"],
  },
  {
    query: "HBR IdeaCast Harvard Business Review",
    feedUrl: "http://feeds.harvardbusiness.org/harvardbusiness/ideacast",
    label: "HBR IdeaCast",
    publisher: "Harvard Business Review",
    lang: "en",
    why: "Weekly conversations with leading thinkers in business strategy, management, and workplace leadership.",
    topics: ["Business", "Leadership"],
  },
  {
    query: "The McKinsey Podcast McKinsey & Company",
    feedUrl: "https://www.omnycontent.com/d/playlist/708664bd-6843-4623-8066-aede00ce0c8a/3f6f52af-fba1-496d-b11b-af040139456a/bfe0b44a-082f-495a-952a-af0401394590/podcast.rss",
    label: "The McKinsey Podcast",
    publisher: "McKinsey & Company",
    lang: "en",
    why: "In-depth conversations with McKinsey experts on global business trends, strategy, and leadership.",
    topics: ["Business", "Leadership", "Economics"],
  },
